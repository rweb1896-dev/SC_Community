...
public final class HelpChatDtos {
 ...
 public record MyHelpPostResponse(Long id,String title,String content,Long categoryId,String categoryName,PostStatus status,Instant createdAt,Instant closedAt,long helperCount,long activeConversationCount){ }
